...
export const PricingCard: FC<Props> = (props) => {
    if (props.for === 'paid') {
        return (
            <>
                <Text className="columnprice text-[55px] ml-5 mb-0" as="h1" variant="h1">
                    {props.price}
                </Text>
                <Row className="items-start justify-between 3xl:ml-[10px] lg:ml-[6px] xl:ml-[8px] 2xl:ml-[9px] lg:mr-[3px] xl:mr-[4px] 2xl:mr-[5px] 3xl:mr-[6px] 2xl:mt-[10px] 3xl:mt-[12px] lg:mt-[7px] xl:mt-[8px] w-[97%]">
                    <Text className="rowforever1 font-bold ml-6 lg:ml-1" as="h5" variant="h5">
                        {props.priceLabel} 
                    </Text> 
                    <Button
                    ...
                    return (
                        <Row className="items-center mx-5 my-2 lg:mr-[auto] lg:mt-1 lg:w-[75%]" key={index}>
                            <Img
                                ...
                                alt="checkmark Two"
                            />
                            <Text className="rowcheckmark  text-[15px] mx-2" as="h5" variant="h5">
                                {value}
                            </Text>
                        </Row>
                    );
        ...
        return (
            <>
                <Text className="columnfree text-[55px] ml-5" as="h1" variant="h1">
                    {props.price}
                </Text>
                <Row className="items-start justify-between 3xl:ml-[10px] lg:ml-[6px] xl:ml-[8px] 2xl:ml-[9px] lg:mr-[3px] xl:mr-[4px] 2xl:mr-[5px] 3xl:mr-[6px] 2xl:mt-[10px] 3xl:mt-[12px] lg:mt-[7px] xl:mt-[8px] w-[97%]">
                    <Text className="rowforever1 font-bold ml-6 lg:ml-1" as="h5" variant="h5">
                    ...
                    <Button
                        className="font-almarai font-bold px-3 xl:mt-[10px] 2xl:mt-[12px] 3xl:mt-[14px] lg:mt-[8px] lg:text-[11px] xl:text-[14px] 2xl:text-[16px] 3xl:text-[19px] lg:text-center lg:w-[23%]"
                        shape="CustomBorderTL4"
                        size="sm"
                        variant="FillGray900"
                    >
