...
const Header: FC<Props> = (props) => {
  ...
  <nav className="bg-white border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-gray-900 w-[100%]">
  ...
  return (
    <>
      <Row className="font-almarai items-start w-full">
        <Img
        ...
        <Row className="items-start justify-center my-[auto] mx-[auto] w-[90%]">
          {[
            ...
            <>
              <NavLink className={navClass(url)} to={url}>
                <Text
